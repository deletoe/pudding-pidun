...
| 预设 | 图片质量 | 最大边长 | 最大 DPI | 视频编码 | 视频 CRF | 帧率 | 音频码率 |
|------|----------|----------|----------|----------|----------|----------|----------|
| `balanced`（默认） | 75% | 2560 px | 150 | x265 | 34 | ≤24fps | 8 kbps |
| `aggressive` | 60% | 1920 px | 96 | x265 | 38 | ≤24fps | 8 kbps |
| `high` | 85% | 4096 px | 200 | x265 | 30 | ≤24fps | 8 kbps |

`balanced` 预设下，视频音频会降为单声道 8kbps，帧率上限 24fps，x265 CRF 34 极限压缩。
